/** M0 静态渲染样例（占位工作台）；N3 起替换为 VSCode 式三栏真工作台。 */
...
> M0 阶段为静态渲染样例；N3 接入 useChat 后由 Run 流实时驱动。`
    ...
    <main className="mx-auto flex h-full max-w-3xl flex-col px-4">
      <header className="py-4">
        ...
        <p className="text-muted-foreground text-sm">
          ai-elements 组件演示：Conversation / Task / Tool / PromptInput（N3 接入 useChat 实时流）
        </p>
      </header>
      ...
      <div className="py-4">
        <PromptInput onSubmit={() => {}}>
          <PromptInputBody>
            <PromptInputTextarea placeholder="M0 静态样例：N3 将接入 useChat 实时流" />
          </PromptInputBody>
          <PromptInputFooter>
            <PromptInputTools />
